...
export function DropZone({ onFilesAdded, fileCount }: DropZoneProps) {
    ...
    return (
        <div
            {...getRootProps()}
            className={`group relative border-2 border-dashed rounded-3xl px-8 py-20 transition-all duration-500 cursor-pointer flex flex-col items-center justify-center text-center overflow-hidden ${isDragActive
        ...
        >
            ...
            {fileCount > 0 ? (
                <div className="relative w-32 h-32 mb-8 group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="absolute inset-0 bg-orange-500 border-4 border-white rounded-3xl shadow-xl z-20 flex items-center justify-center overflow-hidden">
                        <div className="flex flex-col items-center text-white">
                            <span className="text-3xl font-black">{fileCount}</span>
                ...
                <div className={`w-20 h-20 rounded-3xl flex items-center justify-center transition-all duration-300 mb-6 ${isDragActive ? 'bg-orange-100 text-orange-600 scale-110 rotate-12' : 'bg-slate-100 text-slate-400 group-hover:bg-orange-100 group-hover:text-orange-500'
                    }`}>

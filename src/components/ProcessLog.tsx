...
export function ProcessLog({ logs, isProcessing, onClose }: ProcessLogProps) {
    ...
    return (
        ...
        >
            <div className="bg-slate-900 rounded-3xl shadow-xl border border-slate-800">
                ...
                <div
                    ref={scrollRef}
                    className="p-5 max-h-[160px] overflow-y-auto font-mono text-[11px] leading-relaxed space-y-2 custom-scrollbar selection:bg-orange-500/30"
                >
                    {logs.map((log, i) => {
